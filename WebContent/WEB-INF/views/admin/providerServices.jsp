...
<table style="background-color: white; margin: auto;"align="center" border="1">
		...
		<caption>Provider's services</caption>
		<tr>
				<td>sid</td>
				<td>pid</td>
				<td>Provider name</td>
				...
				<td>Rate</td>
				<td>Service</td>
				<td>Verifation Status</td>
				<td>Delete</td>
				<td>Approve</td>
				
			</tr>
		<c:forEach var="v" items="${requestScope.ProviderServiceList}">
			<tr>
				...
				<td>${v.rate}</td>
				<td>${v.serviceType}</td>
				<td>${v.verification}</td>
				<td><a href="<spring:url value='/admin/deleteservice?sid=${v.sid}&pid=${v.pid}'/>">Delete</a></td>
				<td><a href="<spring:url value='/admin/verifyservice?sid=${v.sid}'/>">Approve</a></td>
